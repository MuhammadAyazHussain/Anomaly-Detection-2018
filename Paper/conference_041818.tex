...
\author{\IEEEauthorblockN{Ioannis Iossifidis}
...
email address}
\and
\IEEEauthorblockN{Muhammad Ayaz Hussain}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
\textit{name of organization (of Aff.)}\\
Bochum, Germany \\
email address}
...
\begin{abstract}
This paper is concerned about the use of unsupervised learning algorithms in power consumption data, as well as the comparison of the performance between statistical method and Undercomplete Autoencoder in classification.
...
Presently, it is very difficult to predict the energy consumption anomalies precisely, since there are many factors influencing the energy usage, such as weather condition, building structure and characters, geographic location, occupancy \cite{bb1} and operation of appliances \cite{bb2,bb3}. 
