...
\begin{figure}[H]
	...
	\begin{subfigure}[h]{0.45\textwidth}
		\includegraphics[width=\linewidth]{with_OL.jpg}
	...
	\begin{subfigure}[h]{0.45\textwidth}
		\includegraphics[width=\linewidth]{without_OL.jpg}
		\caption{Energy Consumption during the month of January by store 105
			without outliers}
		\label{fig:OLX1}
	\end{subfigure}
	\caption{Performance of Outlier Detection Algorithm}
	\label{fig:conf}
\end{figure}
